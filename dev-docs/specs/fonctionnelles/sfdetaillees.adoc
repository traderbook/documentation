...
Si l'utilisateur ne saisit pas les bonnes informations d'authentification, celui-ci reste sur le formulaire et voit apparaître un message l'informant que les informations d'authentification ne sont pas correctes.
