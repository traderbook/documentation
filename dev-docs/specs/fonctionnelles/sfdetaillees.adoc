...
[plantuml, creation-profil, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, authentification, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, authentification-erreur, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, scenario-creation-compte, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, scenario-modification-compte, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, scenario-suppression-compte, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, scenario-connection-compte, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, gestion-positions, format="svg"]
....
salt
{+
...
[plantuml, gestion-ordres, format="svg"]
....
salt
{+
...
[plantuml, gestion-historique, format="svg"]
....
salt
{+
...
[plantuml, ouverture-ordre, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, liste-instruments-financiers, format="svg"]
....
salt
{
{
...
[plantuml, recherche-instruments-financiers, format="svg"]
....
(*) -right-> "
{{
salt
...
[plantuml, interface-zone-graphique, format="svg"]
....
salt
{
{/ <b>EURUSD | GBPUSD }
...
[plantuml, barre-outil-graphiques, format="svg"]
....
salt
{
{+
...
[plantuml, configuration-parametres, format="svg"]
....
salt
{
{+
...
[plantuml, listing-backtests, format="svg"]
....
salt
{#
...
[plantuml, analyse-performances, format="svg"]
....
salt
{+
...
Différentes informations doivent être disponibles pour l'utilisateur :
